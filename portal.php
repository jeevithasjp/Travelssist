...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">
			<p>Welcome To Tourism Guide Website</p>
...
<section class="page-section" id="info">
	<div class="container">
		<div class="text-center">
			<h2 class="section-heading text-uppercase">Regions of INDIA</h2>
		</div>
		<div>
			<div class="card w-100">
				<div class="card-body">
					...
					<div class="image-grid">
						<div class="row">
							<a href="places/north_india/north_india.php">
								<img src="assets/img/Ladakh_1466686621 (1).jpg" alt="Clickable Image 1">
								<p>North India</p>
							</a>
							<a href="places\south_india\south_india.php">
								<img src="assets/img/Hampi_14.jpg" alt="Clickable Image 2">
								<p>South India</p>
							</a>

						</div>
						<div class="row">
							<a href="places/west_india/west_india.php">
								<img src="assets/img/Goa_104.jpg" alt="Clickable Image 4">
								<p>West India</p>
							</a>
							<a href="places/NE india/north_east_india.php">
								<img src="assets/img/Meghalaya4345_1462947640.jpg" alt="Clickable Image 5">
								<p>North East India</p>
							</a>

						</div>
						<div class="row">
							<a href="places/east_india/east_india.php">
								<img src="assets/img/Darjeeling_11.jpg" alt="Clickable Image 3">
								<p>East India</p>
							</a>
							<a href="places/central_india/central_india.php">
								<img src="assets/img/Orchha_101.jpg" alt="Clickable Image 6">
								<p>Central India</p>
							</a>
						</div>
					</div>
