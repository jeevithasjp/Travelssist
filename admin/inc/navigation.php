<style>
  ...
  .main-sidebar sidebar-light-dark elevation-4 bg-primary text-white {
    background-color: blanchedalmond;

  }
</style>
<body  style="background-color: rgb(217,170,0);">
...
<aside class="main-sidebar sidebar-light-dark elevation-4 bg-primary text-white">
    ...
    <a href="<?php echo base_url ?>admin" class="brand-link bg-primary text-sm"  >
      ...
      <span class="brand-text font-weight-light"><h2>TRAVELSSIST</h2></span>
    </a>
  ...
  <div
   ...
   >
    ...
    <div class="os-content-glue"
      style="margin: 0px -8px; width: 249px; height: 646px;"></div>
          ...
          <nav class="mt-4">
            <ul
              ...
              <li class="nav-item dropdown">
                ...
                <a href="<?php echo base_url ?>admin/?page=payment" class="nav-link nav-blogs">
